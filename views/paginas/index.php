...
<section class="speakers">
    ...
    <p class="speakers__descripcion">Conoce a nuestros expertos de ConferencePsychology</p>
...
<section class="boletos">
    ...
    <p class="boletos__descripcion">Precios para ConferencePsychology</p>

    <div class="boletos__grid">
        <div class="boleto boleto--presencial">
            <h4 class="boleto__logo">ConferencePsychology</h4>
